    ...
    <body>
            ...
            <!-- NAVBAR START -->
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="navbar-example2">
                    ...
                    <button class="btn btn-warning"><a href="/pay"><i class="fas fa-cart-arrow-down"></i></a></button>
                      </nav>
                      <!-- navbar ends -->\
                      <div class="container">
                      <div class="media">
                            <img class="img-thumbnail"src="https://blog.hdwallsource.com/wp-content/uploads/2016/01/corgi-dog-wallpaper-49391-51060-hd-wallpapers.jpg" class="mr-3" alt="...">
